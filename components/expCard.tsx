...
function ExpCard({ date, firm, job_title, info, icon }: any) {
  return (
    <div className="group ">
      <div className="flex items-center gap-6 group-even max-w-[600px] min-w-[320px]">
        <div className="group-even:order-2">
          <div className="shadow-md rounded-lg px-4 py-4 bg-blue-100 dark:bg-gray-800 ">
            <span className=" font-poppins text-[0.7rem] text-gray-500 dark:text-gray-300">
              {date}
            </span>
            <h2 className="font-bold text-base dark:text-gray-50/80 ">{firm}</h2>
