...
function ProjectCard({ link, title, desc }: any) {
  return (
    <div>
      <div className="dark:bg-gray-800/60 bg-blue-100 shadow-md px-3 py-2 rounded-lg md:max-w-[350px]">
        <a href={link} target="_blank">
          <div className=" flex gap-2 items-center bg-blue-600/30 dark:bg-gray-800/70 px-3 py-2 rounded-lg ">
